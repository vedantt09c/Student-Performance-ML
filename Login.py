...
title=tk.Label(root, text="Login Here", font=("Algerian", 30, "bold","italic"),bd=5,bg="#B22222",fg="white")
title.place(x=580,y=75,width=300)
...
Login_frame=tk.Frame(root,bg="#B22222")
